 ...
 <footer class="main-footer padding-top">
            ...
            <div class="footerWhite">
              <div class="row">
                <div class="small-7 columns">
                  <h4>Share<br>White Night<br>Melbourne</h4>
                </div>
  ...
  <div class="row margin-top2">
    ...
    <div class="small-6 columns right">
      <small>
        <a href="<?php echo $siteURL ?>/privacy-policy">Privacy Policy</a><br>
     Website by <a href="http://acmn.com.au" target="_blank">ACMN</a>
      </small>
    </div>
  </div>
  <div class="row hide-for-medium-up margin-top2">
    <div class="small-6 columns">
      <img src="<?php bloginfo('template_url') ?>/img/MEL_VA_REV_87.png" alt="Melbourne"><br><br>
...
<script type="text/javascript">
adroll_adv_id = "RZWMAT4XU5HYNLJGQXQ4U4";
adroll_pix_id = "RS3IM6NWWFAJZG73VON6PL";
(function () {
...
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 975298894;
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/975298894/?value=0&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
